    ...
    $.extend({
    	...
    	table: {
            ...
            importExcel: function(formId) {
            	...
            	layer.open({
            		...
            		btn: ['<i class="fa fa-check"></i> export', '<i class="fa fa-remove"></i> cancel'],
            		// 弹层外区域Close
            		shadeClose: true,
            		btn1: function(index, layero){
            			var file = layero.find('#file').val();
            			if (file == '' || (!$.common.endWith(file, '.xls') && !$.common.endWith(file, '.xlsx'))){
            				$.modal.msgWarning("Please select a file with the suffix \"XLS\" or \"xlsx\"。");
            				return false;
            			}
    	...
    	modal: {
            ...
            openOptions: function (options) {
                ...
                var _btn = ['<i class="fa fa-check"></i> Determine', '<i class="fa fa-close"></i> Close'];
        ...
        operate: {
            ...
            remove: function(id) {
            	table.set();
            	$.modal.confirm("Are you sure to delete the " + table.options.modalName + " information？", function() {
            ...
            removeAll: function() {
        		...
        		$.modal.confirm("Are you sure to delete "+ rows.length +" selected data?", function() {
            ...
            successTabCallback: function(result) {
                if (result.code == web_status.SUCCESS) {
    	            ...
    	            var $contentWindow = $('.Felix_iframe[data-id="' + currentId + '"]', topWindow)[0].contentWindow;
    	            $.modal.close();
