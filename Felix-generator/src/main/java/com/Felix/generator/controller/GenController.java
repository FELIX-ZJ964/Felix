package com.Felix.generator.controller;
...
import com.Felix.common.core.domain.CxSelect;
...
import com.Felix.common.utils.security.PermissionUtils;
import com.Felix.generator.domain.GenTable;
import com.Felix.generator.domain.GenTableColumn;
import com.Felix.generator.service.IGenTableColumnService;
...
public class GenController extends BaseController
{
    ...
    public AjaxResult editSave(@Validated GenTable genTable)
    {
        ...
        for (GenTableColumn genTableColumn : genTableColumns){
            ...
            newList.add(genTableColumn) ;
        }

        genTable.setColumns(newList);
    ...
    {
        response.reset();
        response.setHeader("Content-Disposition", "attachment; filename=\"Felix.zip\"");
